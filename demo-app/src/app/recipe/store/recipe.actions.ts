...
export const RECIPE_STORE_ALL = '[Recipe] RECIPE_STORE_ALL';
...
export class StoreAllRecipes implements Action {
    readonly type = RECIPE_STORE_ALL;
}


export type RecipeActions = AddRecipe | DeleteRecipe | UpdateRecipe | UpdateAllRecipes | FetchAllRecipes | StoreAllRecipes;
